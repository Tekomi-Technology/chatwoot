class Integrations::Tekomi::ProcessorService < Integrations::BotProcessorService
  pattr_initialize [:event_name!, :hook!, :event_data!]

  private

  def get_response(_session_id, message_content)
    call_tekomi(message_content)
  end
  ...
  def call_tekomi(message_content)
    url = "#{GlobalConfigService.load('TEKOMI_API_URL',
