...
const DISMISS_STORE = 'tekomi_overview_coverage_banner';
...
<template>
  ...
  >
    <div class="flex items-center gap-2 min-w-0">
      ...
      <span class="truncate">
        {{
          $t('TEKOMI.OVERVIEW.COVERAGE_BANNER.TEXT', {
    ...
    <div class="flex items-center gap-1 shrink-0">
      ...
      >
        {{ $t('TEKOMI.OVERVIEW.COVERAGE_BANNER.ACTION') }}
      </button>
      <button
        type="button"
        class="grid rounded-lg size-7 place-content-center hover:bg-n-amber-4"
        :aria-label="$t('TEKOMI.OVERVIEW.COVERAGE_BANNER.DISMISS')"
        @click="dismiss"
      >
