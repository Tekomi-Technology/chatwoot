...
RSpec.describe Tekomi::ConversationOutcomeTracker do
  ...
  describe '#record_reopen' do
    ...
    it 'ignores boundaries for conversations without Tekomi history' do
  ...
  describe '#record_handoff' do
    ...
    it 'snapshots message facts and records the handoff reason' do
      ...
      expect(initial.reload).to have_attributes(
        ...
        first_tekomi_reply_at: first_reply.created_at,
        last_tekomi_reply_at: last_reply.created_at,
  ...
  describe '#record_resolution' do
    ...
    it 'snapshots Tekomi and human replies through resolution' do
      tekomi_reply = create(
        :message,
        account: account, inbox: inbox, conversation: conversation,
        sender: assistant, message_type: :outgoing, created_at: 20.minutes.ago.change(usec: 0)
      ...
      expect(initial.reload).to have_attributes(
        tekomi_reply_count: 1,
        first_tekomi_reply_at: tekomi_reply.created_at,
        last_tekomi_reply_at: tekomi_reply.created_at,
