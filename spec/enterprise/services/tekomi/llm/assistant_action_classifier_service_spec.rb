...
RSpec.describe Tekomi::Llm::AssistantActionClassifierService do
  ...
  describe '#classify' do
    ...
    it 'passes delimited custom instructions and classifier context to the LLM' do
      expect(mock_chat).to receive(:with_schema).with(Tekomi::AssistantActionSchema).and_return(mock_chat)
