...
RSpec.describe Tekomi::AssistantMigration::InstructionClassifier do
  describe Tekomi::AssistantMigration::InstructionClassifierSchema do
  ...
  describe 'classifier prompt' do
    it 'keeps the model focused on active behavior and approved FAQ candidates' do
      prompt = Tekomi::PromptRenderer.render('instruction_classifier')
  ...
  describe Tekomi::AssistantMigration::InstructionAuditorSchema do
  ...
  describe 'auditor prompt' do
    it 'adds missing coverage without replacing the generated draft' do
      prompt = Tekomi::PromptRenderer.render('instruction_auditor')
  ...
  describe 'audited payload' do
    it 'appends a review note for an unavailable runtime capability' do
      service = described_class.new(assistant: instance_double(Tekomi::Assistant))
      generated_draft = {
        response_guidelines: [],
        guardrails: [],
        scenario_candidates: [],
