...
RSpec.describe 'Api::V1::Accounts::Tekomi::FaqSuggestions', type: :request do
  ...
  describe 'GET /api/v1/accounts/:account_id/tekomi/faq_suggestions' do
    it 'returns suggestions and their count to an administrator' do
      get "/api/v1/accounts/#{account.id}/tekomi/faq_suggestions",
  ...
  describe 'GET /api/v1/accounts/:account_id/tekomi/faq_suggestions/:id' do
    it 'returns the suggestion with its source conversation' do
      get "/api/v1/accounts/#{account.id}/tekomi/faq_suggestions/#{suggestion.id}",
          headers: admin.create_new_auth_token,
          as: :json
  ...
  describe 'PATCH /api/v1/accounts/:account_id/tekomi/faq_suggestions/:id' do
    it 'lets an administrator edit an open suggestion' do
      patch "/api/v1/accounts/#{account.id}/tekomi/faq_suggestions/#{suggestion.id}",
  ...
  describe 'POST /api/v1/accounts/:account_id/tekomi/faq_suggestions/:id/approve' do
    it 'lets an administrator approve an edited suggestion as an FAQ' do
      expect do
        post "/api/v1/accounts/#{account.id}/tekomi/faq_suggestions/#{suggestion.id}/approve",
  ...
  describe 'POST /api/v1/accounts/:account_id/tekomi/faq_suggestions/:id/dismiss' do
    it 'lets an administrator dismiss an open suggestion without creating an FAQ' do
      expect do
        post "/api/v1/accounts/#{account.id}/tekomi/faq_suggestions/#{suggestion.id}/dismiss",
             headers: admin.create_new_auth_token,
             as: :json
      end.not_to change(assistant.responses, :count)
