...
RSpec.describe Tekomi::Tools::AddPrivateNoteTool, type: :model do
  ...
  describe '#execute' do
    ...
    it 'keeps legacy public-tool side effects for Tekomi V1' do
      expect do
    ...
    it 'skips stale public-tool side effects for Tekomi V2' do
