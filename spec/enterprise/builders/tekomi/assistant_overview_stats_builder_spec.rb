...
RSpec.describe Tekomi::AssistantOverviewStatsBuilder do
  ...
  context 'with demand in both windows' do
    before do
      ...
      create(
        ...
        first_tekomi_reply_at: demand_start + 30.seconds,
      ...
      create(
        ...
        inbox: inbox,
        started_at: demand_start,
        first_tekomi_reply_at: demand_start + 60.seconds,
        tekomi_reply_count: 1,
      ...
      create(
        ...
        inbox: inbox,
        started_at: demand_start,
        first_tekomi_reply_at: demand_start + 90.seconds,
        tekomi_reply_count: 1,
      ...
      create(
        ...
        inbox: inbox,
        started_at: demand_start,
        first_tekomi_reply_at: demand_start + 120.seconds,
        tekomi_reply_count: 2,
      ...
      create(
        ...
        inbox: inbox,
        started_at: demand_start,
        first_tekomi_reply_at: demand_start + 45.seconds,
        tekomi_reply_count: 1,
  ...
  it 'counts an unclassified handoff as Tekomi involvement' do
    create(
      :conversation_outcome,
      account: account,
      assistant: assistant,
  ...
  it 'does not count an episode in both adjacent day windows' do
    travel_to Time.zone.parse('2026-08-12 12:00:00') do
      create(
        ...
        first_tekomi_reply_at: 7.days.ago
      )
  ...
  it 'compares Tekomi CSAT with conversations where Tekomi never participated' do
    ...
    involved_outcome = create(
      ...
      inbox: inbox,
      started_at: 5.days.ago,
      first_tekomi_reply_at: 5.days.ago,
      csat_rating: 5
    )
