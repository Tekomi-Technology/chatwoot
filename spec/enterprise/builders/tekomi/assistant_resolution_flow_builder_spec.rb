...
RSpec.describe Tekomi::AssistantResolutionFlowBuilder do
    ...
    it 'returns an empty flow with stable nodes and links' do
      expect(resolution_flow).to eq(
        sankey: {
          ...
          links: [
            { source: :conversations_handled, target: :resolved_by_tekomi, value: 0 },
            { source: :conversations_handled, target: :handed_off, value: 0 },
            { source: :conversations_handled, target: :closed_with_team, value: 0 },
            { source: :resolved_by_tekomi, target: :reopened_within_7_days, value: 0 },
            { source: :resolved_by_tekomi, target: :stayed_closed, value: 0 }
          ]
        },
  ...
  context 'with handled outcomes in the current window' do
    before do
      ...
      create(
        ...
        first_tekomi_reply_at: reopened_start + 1.minute,
      ...
      create(
        ...
        first_tekomi_reply_at: boundary_start + 1.minute,
      ...
      create(
        ...
        first_tekomi_reply_at: recent_start + 1.minute,
      ...
      create(
        ...
        first_tekomi_reply_at: assisted_start + 1.minute,
    ...
    it 'builds a balanced resolution flow' do
      expect(resolution_flow[:sankey]).to eq(
        ...
        links: [
          { source: :conversations_handled, target: :resolved_by_tekomi, value: 3 },
          { source: :conversations_handled, target: :handed_off, value: 5 },
          { source: :conversations_handled, target: :closed_with_team, value: 1 },
          { source: :resolved_by_tekomi, target: :reopened_within_7_days, value: 1 },
          { source: :resolved_by_tekomi, target: :stayed_closed, value: 2 },
