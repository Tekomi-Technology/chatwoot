...
RSpec.describe Tekomi::AgentSession, type: :model do
  ...
  describe '#subject' do
    it 'returns the conversation for an assistant session' do
      ...
      session = create(:tekomi_agent_session, account: account, assistant: assistant, subject: conversation)
    ...
    it 'returns the copilot thread for a copilot session' do
      ...
      copilot_thread = create(:tekomi_copilot_thread, account: account, user: user, assistant: assistant)
      session = create(:tekomi_agent_session, :copilot, account: account, assistant: assistant, user: user, subject: copilot_thread)
    ...
    it 'is not valid when the subject type does not match the session type' do
      copilot_thread = create(:tekomi_copilot_thread, account: account, user: create(:user, account: account), assistant: assistant)
      session = build(:tekomi_agent_session, account: account, assistant: assistant, subject: copilot_thread)
    ...
    it 'is not valid when the subject belongs to a different account' do
      ...
      session = build(:tekomi_agent_session, account: account, assistant: assistant, subject: foreign_conversation)
  ...
  describe '#result' do
    it 'returns the message for an assistant session' do
      ...
      session = create(:tekomi_agent_session, account: account, assistant: assistant, subject: conversation, result: message)
    ...
    it 'returns the copilot message for a copilot session' do
      user = create(:user, account: account)
      copilot_thread = create(:tekomi_copilot_thread, account: account, user: user, assistant: assistant)
      copilot_message = create(:tekomi_copilot_message, account: account, copilot_thread: copilot_thread)
      session = create(:tekomi_agent_session, :copilot, account: account, assistant: assistant, user: user,
    ...
    it 'returns nil when result_id is nil' do
      session = create(:tekomi_agent_session, account: account, assistant: assistant)
    ...
    it 'is not valid when the result belongs to a different account' do
      ...
      session = build(:tekomi_agent_session, account: account, assistant: assistant, subject: conversation, result: foreign_message)
    ...
    it 'is not valid when result_id/result_type are set directly for a different account' do
      conversation = create(:conversation, account: account)
      foreign_message = create(:message, account: create(:account))
      session = build(:tekomi_agent_session, account: account, assistant: assistant, subject: conversation,
  ...
  describe 'account' do
    ...
    it 'overrides a mismatched explicit account with the assistant account' do
      conversation = create(:conversation, account: account)
      session = build(:tekomi_agent_session, account: create(:account), assistant: assistant, subject: conversation)
  ...
  describe 'factory' do
    ...
    it 'builds a valid copilot session' do
      session = create(:tekomi_agent_session, :copilot, account: account, assistant: assistant)
