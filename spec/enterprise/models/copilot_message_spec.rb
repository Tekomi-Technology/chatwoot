  ...
  describe 'callbacks' do
    ...
    describe '#ensure_account' do
      it 'sets the account from the copilot thread before validation' do
        message = build(:tekomi_copilot_message, copilot_thread: copilot_thread, account: nil)
        message.valid?
    ...
    describe '#broadcast_message' do
      it 'dispatches COPILOT_MESSAGE_CREATED event after create' do
        message = build(:tekomi_copilot_message, copilot_thread: copilot_thread)
