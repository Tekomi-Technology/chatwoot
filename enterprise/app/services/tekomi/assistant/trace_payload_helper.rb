module Tekomi::Assistant::TracePayloadHelper
  private

  def enrich_context_with_trace_payload!(context, message_history, message_to_process)
    context[:tekomi_v2_trace_input] = serialize_trace_messages(message_history)
    context[:tekomi_v2_trace_current_input] = serialize_trace_content(message_to_process)
  end
