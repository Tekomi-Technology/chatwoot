class Tekomi::AssistantMigration::InstructionClassifier < Tekomi::BaseTaskService
  RESPONSE_SCHEMA = Tekomi::AssistantMigration::InstructionClassifierSchema
  ...
  def perform
    ...
    auditor_response = Tekomi::AssistantMigration::InstructionAuditor.new(
      assistant: assistant,
  ...
  def available_agent_tools
    tools = assistant.respond_to?(:available_agent_tools) ? assistant.available_agent_tools : Tekomi::Assistant.built_in_agent_tools
  ...
  def assistant_metadata # rubocop:disable Metrics/AbcSize
    {
      ...
      account_id: assistant.account_id,
      account_name: assistant.account.name,
      inbox_count: assistant.tekomi_inboxes.size,
