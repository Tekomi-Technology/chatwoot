class Tekomi::Copilot::ChatService < Llm::BaseAiService
  include Tekomi::ChatHelper
  include Tekomi::Copilot::ConversationAccess
  ...
  def build_tools
    ...
    tools << Tekomi::Tools::SearchDocumentationService.new(@assistant, user: @user)
    tools << Tekomi::Tools::Copilot::GetConversationService.new(@assistant, user: @user)
    tools << Tekomi::Tools::Copilot::SearchConversationsService.new(@assistant, user: @user)
    tools << Tekomi::Tools::Copilot::GetContactService.new(@assistant, user: @user)
    tools << Tekomi::Tools::Copilot::GetArticleService.new(@assistant, user: @user)
    tools << Tekomi::Tools::Copilot::SearchArticlesService.new(@assistant, user: @user)
    tools << Tekomi::Tools::Copilot::SearchContactsService.new(@assistant, user: @user)
    tools << Tekomi::Tools::Copilot::SearchLinearIssuesService.new(@assistant, user: @user)
