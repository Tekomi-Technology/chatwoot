class Tekomi::Llm::PdfProcessingService < Llm::LegacyBaseOpenAiService
  ...
  def process
    ...
    raise CustomExceptions::Pdf::UploadError, I18n.t('tekomi.documents.pdf_upload_failed') if file_id.blank?
