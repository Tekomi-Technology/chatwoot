class Tekomi::Tools::SimplePageCrawlParserJob < ApplicationJob
  ...
  def perform(assistant_id:, page_link:)
    ...
    crawler = Tekomi::Tools::SimplePageCrawlService.new(page_link)
  ...
  def permanent_failure?(error_code)
    Tekomi::Documents::SyncService::PERMANENT_ERROR_CODES.include?(error_code)
  end
