class Tekomi::Copilot::ReplySuggestionJob < ApplicationJob
  queue_as :default

  retry_on Tekomi::Copilot::ReplySuggestionService::GenerationError, wait: 3.seconds, attempts: 3 do |job, _error|
  ...
  def perform(assistant:, conversation_id:, user_id:, copilot_thread_id:)
    ...
    @reply_suggestion_service = Tekomi::Copilot::ReplySuggestionService.new(
      assistant: assistant,
