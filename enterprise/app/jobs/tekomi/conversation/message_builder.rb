module Tekomi::Conversation::MessageBuilder
  private
  ...
  def create_messages
    return create_v1_message unless tekomi_v2_enabled?
  ...
  def create_outgoing_message(message_content, agent_name: nil, response_parts: nil, preserve_waiting_since: false)
    ...
    additional_attrs[Tekomi::Assistant::ResponseParts::MESSAGE_ATTRIBUTE_KEY] = response_parts unless response_parts.nil?
