class Api::V1::Accounts::Tekomi::BulkActionsController < Api::V1::Accounts::BaseController
  ...
  def handle_assistant_responses
    responses = Current.account.tekomi_assistant_responses.where(id: params[:ids])
  ...
  def delete_documents
    documents = Current.account.tekomi_documents.where(id: params[:ids])
  ...
  def sync_documents
    ...
    Current.account.tekomi_documents.where(id: params[:ids]).find_each(batch_size: 100) do |document|
