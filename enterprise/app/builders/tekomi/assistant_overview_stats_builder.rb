# Computes the complete per-assistant metric set for the Tekomi overview.
...
class Tekomi::AssistantOverviewStatsBuilder
  ...
  # Account-wide CSAT from conversations where no Tekomi assistant ever
  ...
  def assistant_messages
    account.messages.where(sender_type: 'Tekomi::Assistant', sender_id: assistant.id, created_at: full_span)
  end
