module Tekomi::ChatResponseHelper
  ...
  def apply_credit_usage_metadata(parsed_response)
    return unless tekomi_v1_assistant?
  ...
  def tekomi_v1_assistant?
    feature_name == 'assistant' && !@assistant.account.feature_enabled?('tekomi_integration_v2')
  end
